...
class IgYtReelsConverter extends Component
{
    ...
    protected function getToolKey(): string { return 'ig_yt_reels_converter'; }
    ...
    public function analyze()
    {
        ...
        try {
            ...
            $this->result = $service->convertYoutubeToReels($this->youtubeUrl, $this->reelsStyle);
            $this->loadHistory();
        } catch (\Exception $e) {
    ...
    {
        return view('appaitools::livewire.enterprise.ig-yt-reels-converter', [
            'loadingSteps' => config('appaitools.enterprise_tools.ig-yt-reels-converter.loading_steps', []),
        ]);
    }
}
