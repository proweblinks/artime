...
class IgShoppingOptimizer extends Component
{
    ...
    protected function getToolKey(): string { return 'ig_shopping_optimizer'; }
    ...
    public function analyze()
    {
        ...
        try {
            ...
            $this->result = $service->analyzeInstagramShopping($this->profile, $this->productType, $this->priceRange);
            $this->loadHistory();
        } catch (\Exception $e) {
    ...
    {
        return view('appaitools::livewire.enterprise.ig-shopping-optimizer', [
            'loadingSteps' => config('appaitools.enterprise_tools.ig-shopping-optimizer.loading_steps', []),
        ]);
    }
}
