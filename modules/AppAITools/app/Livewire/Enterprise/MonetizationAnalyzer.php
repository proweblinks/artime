...
class MonetizationAnalyzer extends Component
{
    ...
    public function analyze()
    {
        ...
        try {
            ...
            $this->result = $service->analyzeMonetization($this->url);
            $this->loadHistory();
        } catch (\Exception $e) {
    ...
    {
        return view('appaitools::livewire.enterprise.monetization-analyzer', [
            'loadingSteps' => config('appaitools.enterprise_tools.monetization-analyzer.loading_steps', []),
        ]);
    }
}
