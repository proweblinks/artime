    ...
    */
    'enterprise_platforms' => [
        ...
        'tiktok' => [
            ...
            'tool_count' => 0,
            'planned_tools' => [
                ['name' => 'TikTok Shop Optimizer', 'emoji' => "\xF0\x9F\x9B\x92", 'description' => 'Optimize product listings and affiliate strategies for TikTok Shop'],
                ['name' => 'Sound Trend Analyzer', 'emoji' => "\xF0\x9F\x8E\xB5", 'description' => 'Identify trending sounds and audio before they peak'],
                ['name' => 'Creator Fund Calculator', 'emoji' => "\xF0\x9F\x92\xB0", 'description' => 'Estimate earnings and optimize for creator fund payouts'],
                ['name' => 'Hashtag Strategy Builder', 'emoji' => "#\xE2\x83\xA3", 'description' => 'Build viral hashtag combos for maximum reach'],
                ['name' => 'Duet & Stitch Planner', 'emoji' => "\xF0\x9F\xA4\x9D", 'description' => 'Find high-engagement duet/stitch opportunities'],
                ['name' => 'Hook Analyzer', 'emoji' => "\xF0\x9F\xAA\x9D", 'description' => 'Analyze and improve your first 3 seconds for retention'],
                ['name' => 'Posting Time Optimizer', 'emoji' => "\xE2\x8F\xB0", 'description' => 'Find optimal posting times based on your audience data'],
                ['name' => 'TikTok SEO Analyzer', 'emoji' => "\xF0\x9F\x94\x8D", 'description' => 'Optimize captions, keywords, and descriptions for TikTok search'],
                ['name' => 'Viral Content Predictor', 'emoji' => "\xF0\x9F\x94\xAE", 'description' => 'Predict viral potential of your content before posting'],
                ['name' => 'Brand Partnership Finder', 'emoji' => "\xF0\x9F\xA4\x9D", 'description' => 'Match with brands looking for TikTok creators'],
            ],
        ],
        'instagram' => [
            'name' => 'Instagram',
