...
">
    ...
    <div class="aith-nav">
        ...
        @if(count($history) > 0)
        <button class="aith-nav-btn" onclick="document.getElementById('aith-history-ca').classList.toggle('aith-open')">
    ...
    {{-- History Panel --}}
    @if(count($history) > 0)
    <div id="aith-history-ca" class="aith-card" style="display:none; margin-top: 1rem;">
        <h3 class="aith-section-title"><i class="fa-light fa-clock-rotate-left"></i> {{ __('Recent Analyses') }}</h3>
    ...
    <style>#aith-history-ca.aith-open { display: block !important; }</style>
    @endif
