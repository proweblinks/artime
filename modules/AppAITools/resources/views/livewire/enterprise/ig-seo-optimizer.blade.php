        ...
        <div class="aith-card">
            <div class="aith-e-tool-header">
                ...
                <div class="aith-e-tool-info">
                    <h2>Instagram SEO Optimizer</h2>
                    <p>Optimize bio, captions, and alt text for Instagram search</p>
                </div>
            ...
            <div class="aith-form-group">
                ...
                @error('caption') <span class="aith-e-field-error">{{ $message }}</span> @enderror
            </div>
            ...
            <button wire:click="analyze" wire:loading.attr="disabled" class="aith-btn-primary" style="width:100%;margin-top:1rem;">
                <span wire:loading.remove wire:target="analyze">
                    <i class="fa-light fa-magnifying-glass"></i> Optimize SEO
                </span>
            ...
            ">
                <div class="aith-e-loading-title">Optimizing Instagram SEO...</div>
            ...
            <div class="aith-e-result-header">
                <span class="aith-e-result-title">Instagram SEO Results</span>
                <div class="aith-e-result-actions">
                    <button onclick="enterprisePdfExport('pdf-content-ig-seo-optimizer', 'IG-SEO-Analysis')" class="aith-e-btn-pdf">
            ...
            <div id="pdf-content-ig-seo-optimizer">
            ...
            <div class="aith-e-score-card">
                ...
                <div class="aith-e-score-info">
                    ...
                    <div class="aith-e-score-text">
                        @if($score >= 80) Excellent SEO optimization - highly discoverable on Instagram search
            ...
            {{-- Search Optimization --}}
            @if(isset($result['search_optimization']))
            <div class="aith-e-section-card">
                <div class="aith-e-section-card-title"><i class="fa-light fa-search"></i> Search Optimization</div>
                @if(!empty($result['search_optimization']['keywords_found']))
                <div style="margin-bottom:0.75rem;">
                    <span style="font-size:0.7rem;color:rgba(255,255,255,0.35);text-transform:uppercase;display:block;margin-bottom:0.375rem;">Keywords Found</span>
                    <div style="display:flex;flex-wrap:wrap;gap:0.375rem;">
                        @foreach($result['search_optimization']['keywords_found'] as $kw)
                        <span class="aith-e-pill aith-e-pill-green">{{ $kw }}</span>
                        @endforeach
                    </div>
                </div>
                @endif
                @if(!empty($result['search_optimization']['keywords_missing']))
                <div>
                    <span style="font-size:0.7rem;color:rgba(255,255,255,0.35);text-transform:uppercase;display:block;margin-bottom:0.375rem;">Keywords Missing</span>
                    <div style="display:flex;flex-wrap:wrap;gap:0.375rem;">
                        @foreach($result['search_optimization']['keywords_missing'] as $kw)
                        <span style="font-size:0.75rem;padding:0.125rem 0.5rem;border-radius:9999px;background:rgba(239,68,68,0.1);color:#fca5a5;">{{ $kw }}</span>
                        @endforeach
                    </div>
                </div>
                @endif
            ...
            <div class="aith-e-section-card">
                ...
                <div class="aith-e-grid-2">
                    @foreach($result['caption_analysis'] as $key => $val)
                    <div style="padding:0.375rem 0;">
            ...
            {{-- Next Steps --}}
            @php
                $nextSteps = config('appaitools.enterprise_tools.ig-seo-optimizer.next_steps', []);
