        ...
        'social' => [
            ...
            'subTypes' => [
                'viral' => [
                    ...
                    'detailedDescription' => 'Hyper-shareable single-shot videos designed to explode on social feeds. Think animals in absurd human situations — a grumpy cat working a pizza counter, a raccoon DJ-ing a house party. One continuous take, 4-15 seconds. The AI generates chaotic physical comedy: objects flying, dramatic reactions, pure visual chaos.',
                    'perfectFor' => [
                        'TikTok & Reels that rack up millions of views',
                        'Animal characters in absurd workplace scenarios',
                        'Physical comedy with dramatic reactions',
                        'Quick-hit content that hooks in the first second',
                        'Shareable "send this to your friend" moments',
                    ],
                    'exampleScenario' => 'A fluffy orange cat in a green apron stands behind a pizza counter, staring down a customer holding an open pizza box. The cat hisses "No refunds!" while slapping the cash register. Pizza boxes tumble off the shelf behind him as the customer backs away slowly.',
                    'characteristics' => ['quick-hook', 'shareable', 'trend-based', 'single-shot', 'lip-sync'],
                    'defaultNarration' => 'monologue',
                    'suggestedDuration' => ['min' => 8, 'max' => 15],
                ],
                'educational-short' => [
                    ...
                    'detailedDescription' => 'Bite-sized educational content that makes complex topics instantly understandable. A narrator or animated character walks through a single concept with clear visuals and engaging delivery. Perfect for "Did you know?" content that makes viewers feel smarter.',
                    'perfectFor' => [
                        'Science facts & "Did you know?" content',
                        'Quick tutorials and how-to breakdowns',
                        'History nuggets and fun trivia',
                        'Tech explainers made simple',
                        'Myth-busting and misconception corrections',
                    ],
                    'exampleScenario' => 'A cartoon owl in a lab coat stands in front of a giant chalkboard, drawing diagrams that animate to life. As the narrator explains why the sky is blue, light beams scatter across the screen, bouncing off animated air molecules while the owl nods approvingly.',
                ...
                'story-short' => [
                    ...
                    'detailedDescription' => 'Mini-narratives with a beginning, middle, and twist ending. Emotional arcs packed into seconds — a heartwarming rescue, a spooky urban legend, a surprise reunion. These videos hook viewers with "wait for it" anticipation and deliver satisfying emotional payoffs.',
                    'perfectFor' => [
                        'Mini stories with surprise twist endings',
                        'Heartwarming or emotional "wait for it" moments',
                        'Urban legends and spooky micro-tales',
                        'Character-driven scenarios with an arc',
                        'Inspirational or motivational narratives',
                    ],
                    'exampleScenario' => 'A stray puppy shivers in the rain outside a bakery. The baker notices and looks away. Beat. Then the door opens — the baker sets down a warm blanket and a bowl of food. The puppy looks up with wide eyes. Final shot: same puppy, months later, wearing a tiny baker hat behind the counter.',
                ...
                'product' => [
                    ...
                    'detailedDescription' => 'Attention-grabbing product reveals and demonstrations that make viewers want to buy. Dynamic close-ups, satisfying unboxing moments, and before/after transformations. Built for the "link in bio" economy — show the product being amazing in context.',
                    'perfectFor' => [
                        'Product launches and unboxing reveals',
                        'Before/after transformation showcases',
                        'Satisfying "how it works" demonstrations',
                        'Lifestyle product placement in aspirational settings',
                        'Review-style content with visual proof',
                    ],
                    'exampleScenario' => 'A sleek gadget sits on a minimalist desk, spotlight gleaming. A hand reaches in and presses a button — the device unfolds in a satisfying mechanical sequence. Quick cuts show it in action: at a coffee shop, on a hike, at a work meeting. Final shot: the product floating on a gradient background with a subtle price tag.',
                ...
                'lifestyle' => [
                    ...
                    'detailedDescription' => 'Aspirational day-in-the-life content, morning routines, aesthetic vlogs, and life hack compilations. Visually pleasing with warm color grading, smooth transitions, and a "living my best life" energy. Makes viewers feel inspired and want to adopt the lifestyle shown.',
                    'perfectFor' => [
                        'Morning/evening routine aesthetic content',
                        'Day-in-the-life vlogs and montages',
                        'Life hacks and productivity tips',
                        'Cozy/aesthetic atmosphere videos',
                        'Travel moments and "living the dream" content',
                    ],
                    'exampleScenario' => 'Golden morning light streams through linen curtains. A character stretches, makes pour-over coffee in a sunlit kitchen, journals at a wooden desk. Quick montage of outfit styling, a bike ride through a tree-lined street, and sitting in a cafe with a laptop. Warm, dreamy color grading throughout.',
                ...
                'meme-comedy' => [
                    ...
                    'detailedDescription' => 'Pure comedy built on meme culture and internet humor. Animals lip-syncing to absurd dialogue, "when you..." scenarios, chaotic reaction content. Same cat-chaos energy as Viral/Trending but leaning into specific meme formats and comedy tropes with quotable dialogue lines.',
                    'perfectFor' => [
                        '"When your..." relatable scenario memes',
                        'Animals lip-syncing to absurd dialogue',
                        'Chaotic reaction and overreaction content',
                        'Parody and satire of everyday situations',
                        'Quotable one-liners and comeback humor',
                    ],
                    'exampleScenario' => 'A golden retriever in a tiny business suit sits behind an executive desk, phone to ear. Caption: "When your boss asks if you finished the report." The dog slowly lowers his sunglasses, looks directly at the camera with a deadpan expression, and says "Absolutely not" before taking a long sip from a comically small coffee cup.',
                    'characteristics' => ['humorous', 'relatable', 'shareable', 'single-shot', 'lip-sync'],
                    'defaultNarration' => 'monologue',
                    'suggestedDuration' => ['min' => 8, 'max' => 15],
                ],
            ],
