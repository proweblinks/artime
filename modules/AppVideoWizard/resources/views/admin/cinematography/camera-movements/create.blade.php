...
<div class="border-bottom mb-1 py-4 bg-polygon">
    <div class="container">
        ...
        <div class="fw-7 fs-20 text-primary-700">{{ __('Create Camera Movement') }}</div>
        <p class="text-muted mb-0 small">{{ __('Add a new camera movement preset for AI video animation') }}</p>
    </div>
</div>

<div class="container py-4">
    <form action="{{ route('admin.video-wizard.cinematography.camera-movements.store') }}" method="POST">
        @csrf
