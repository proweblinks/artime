...
<div class="border-bottom mb-1 py-4 bg-polygon">
    <div class="container">
        ...
        <div class="fw-7 fs-20 text-primary-700">{{ __('Create Genre Preset') }}</div>
    </div>
</div>

<div class="container py-4">
    <form action="{{ route('admin.video-wizard.cinematography.genre-presets.store') }}" method="POST">
        @csrf
        @include('appvideowizard::admin.cinematography.genre-presets._form')
    </form>
</div>
@endsection
