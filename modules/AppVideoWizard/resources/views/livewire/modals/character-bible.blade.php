    ...
    <div class="vw-modal"
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="margin-bottom: 0.4rem;">
                                ...
                                <div style="display: flex; gap: 0.25rem; flex-wrap: wrap;">
                                    ...
                                    <button type="button" wire:click="applyCharacterTemplate({{ $editIndex }}, 'mysterious')" style="padding: 0.2rem 0.4rem; background: rgba(var(--vw-primary-rgb), 0.06); border: 1px solid rgba(var(--vw-primary-rgb), 0.12); border-radius: 0.2rem; color: var(--vw-text-secondary); font-size: 0.55rem; cursor: pointer;">🕵️ {{ __('Mysterious') }}</button>
                            ...
                            <div x-data="{ traitsOpen: false, newTrait: '' }" style="margin-bottom: 0.4rem;">
                                <button type="button"
                                    ...
                                    <span style="color: var(--vw-text-secondary); font-size: 0.6rem; transition: transform 0.2s;" :style="traitsOpen ? '' : 'transform: rotate(-90deg)'">▼</span>
                            ...
                            <div x-data="{ dnaOpen: false, presetsOpen: false }" style="margin-bottom: 0.4rem; padding: 0.35rem; background: rgba(var(--vw-primary-rgb), 0.04); border: 1px solid rgba(var(--vw-primary-rgb), 0.08); border-radius: 0.35rem;">
                                ...
                                <button type="button"
                                    ...
                                    <span style="color: var(--vw-text-secondary); font-size: 0.6rem; transition: transform 0.2s;" :style="dnaOpen ? '' : 'transform: rotate(-90deg)'">▼</span>
                                ...
                                <div x-show="dnaOpen" x-collapse style="margin-top: 0.35rem;">
                                    ...
                                    <div style="margin-bottom: 0.35rem;">
                                        <button type="button"
                                            ...
                                            <span style="color: var(--vw-text-secondary); font-size: 0.5rem; transition: transform 0.2s;" :style="presetsOpen ? '' : 'transform: rotate(-90deg)'">▼</span>
                                        ...
                                        <div x-show="presetsOpen" x-collapse style="display: flex; flex-wrap: wrap; gap: 0.2rem;">
                                            ...
                                            <button type="button" wire:click="applyCharacterLookPreset({{ $editIndex }}, 'action-hero-female')" style="padding: 0.15rem 0.3rem; background: rgba(239,68,68,0.15); border: 1px solid rgba(239,68,68,0.3); border-radius: 0.2rem; color: #dc2626; font-size: 0.45rem; cursor: pointer;">🦸‍♀️ {{ __('Action F') }}</button>
                                            <button type="button" wire:click="applyCharacterLookPreset({{ $editIndex }}, 'action-hero-male')" style="padding: 0.15rem 0.3rem; background: rgba(239,68,68,0.15); border: 1px solid rgba(239,68,68,0.3); border-radius: 0.2rem; color: #dc2626; font-size: 0.45rem; cursor: pointer;">🦸‍♂️ {{ __('Action M') }}</button>
                            ...
                            <div x-data="{ voiceOpen: false }" style="margin-bottom: 0.4rem; padding: 0.35rem; background: rgba(16,185,129,0.08); border: 1px solid rgba(16,185,129,0.2); border-radius: 0.35rem;">
                                ...
                                <button type="button"
                                        ...
                                        style="display: flex; align-items: center; gap: 0.25rem; width: 100%; background: none; border: none; padding: 0; cursor: pointer;">
                                    <span style="color: #16a34a; font-size: 0.6rem; transition: transform 0.2s;" :style="voiceOpen ? '' : 'transform: rotate(-90deg)'">▼</span>
                                    <span style="color: #16a34a; font-size: 0.65rem; font-weight: 600;">🎙️ {{ __('Character Voice') }}</span>
                                ...
                                <div x-show="voiceOpen" x-collapse style="margin-top: 0.35rem;">
                                    ...
                                    <div style="margin-bottom: 0.35rem;">
                                        ...
                                        <div style="display: flex; flex-wrap: wrap; gap: 0.2rem;">
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'hero-male')" style="padding: 0.15rem 0.3rem; background: rgba(6,182,212,0.15); border: 1px solid rgba(6,182,212,0.3); border-radius: 0.2rem; color: #0891b2; font-size: 0.45rem; cursor: pointer;">🦸‍♂️ {{ __('Hero M') }}</button>
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'hero-female')" style="padding: 0.15rem 0.3rem; background: rgba(236,72,153,0.15); border: 1px solid rgba(236,72,153,0.3); border-radius: 0.2rem; color: #be185d; font-size: 0.45rem; cursor: pointer;">🦸‍♀️ {{ __('Hero F') }}</button>
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'villain-male')" style="padding: 0.15rem 0.3rem; background: rgba(var(--vw-primary-rgb), 0.06); border: 1px solid rgba(var(--vw-primary-rgb), 0.12); border-radius: 0.2rem; color: var(--vw-text-secondary); font-size: 0.45rem; cursor: pointer;">🦹‍♂️ {{ __('Villain M') }}</button>
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'villain-female')" style="padding: 0.15rem 0.3rem; background: rgba(var(--vw-primary-rgb), 0.06); border: 1px solid rgba(var(--vw-primary-rgb), 0.12); border-radius: 0.2rem; color: var(--vw-text-secondary); font-size: 0.45rem; cursor: pointer;">🦹‍♀️ {{ __('Villain F') }}</button>
                    ...
                    <div style="margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid var(--vw-border);">
                        ...
                        @if($appliedCount === 0 && $totalScenes > 0)
                            <div style="padding: 0.35rem 0.5rem; margin-bottom: 0.3rem; background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: 0.25rem;">
                                <span style="color: #dc2626; font-size: 0.55rem;">⚠️ {{ __('Please assign at least one scene to this character') }}</span>
                            </div>
                        @endif
        ...
        <div style="padding: 0.5rem 1rem; border-top: 1px solid var(--vw-border); display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
            <label style="display: flex; align-items: center; gap: 0.4rem; color: var(--vw-text); font-size: 0.7rem; cursor: pointer;">
                <input type="checkbox" wire:model.live="sceneMemory.characterBible.enabled" style="accent-color: var(--vw-primary);">
