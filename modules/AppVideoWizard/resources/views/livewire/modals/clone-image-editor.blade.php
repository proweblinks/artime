    ...
    <div class="vw-modal"
        ...
        <div style="padding: 1rem 1.25rem; border-bottom: 1px solid rgba(255,255,255,0.1); display: flex; justify-content: space-between; align-items: center;">
            <div>
                ...
                <p style="margin: 0.25rem 0 0 0; color: rgba(255,255,255,0.5); font-size: 0.8rem;">{{ __('Edit or reimagine your first frame before creating video') }}</p>
            </div>
        ...
        <div style="flex: 1; overflow-y: auto; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem; border-top: 1px solid rgba(255,255,255,0.08);">
            ...
            <div style="position: relative; border-radius: 0.5rem; overflow: hidden; background: rgba(0,0,0,0.5); border: 1px solid rgba(255,255,255,0.08);">
                ...
                <div wire:loading wire:target="applyCloneImageEdit, reimagineCloneImage"
                    ...
                    <div style="width: 36px; height: 36px; border: 3px solid rgba(139,92,246,0.3); border-top-color: #a78bfa; border-radius: 50%; animation: spin 1s linear infinite;"></div>
            ...
            <div x-show="activeTab === 'edit'" x-cloak>
                ...
                <div>
                    <label for="clone-edit-prompt" style="display: block; color: rgba(255,255,255,0.6); font-size: 0.75rem; font-weight: 500; margin-bottom: 0.35rem;">{{ __('Custom Edit Prompt') }}</label>
            ...
            <div x-show="activeTab === 'reimagine'" x-cloak>
                ...
                <div>
                    <label for="clone-reimagine-prompt" style="display: block; color: rgba(255,255,255,0.6); font-size: 0.75rem; font-weight: 500; margin-bottom: 0.35rem;">{{ __('Custom Style Description') }}</label>
