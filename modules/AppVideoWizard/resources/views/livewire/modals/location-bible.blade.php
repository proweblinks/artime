    ...
    <div class="vw-modal"
        ...
        <div style="padding: 0.5rem 1rem; border-bottom: 1px solid var(--vw-border); display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
            ...
            <div style="display: flex; align-items: center; gap: 0.5rem;">
                ...
                @endif
                <button type="button" wire:click="closeLocationBibleModal" style="background: none; border: none; color: var(--vw-text-secondary); font-size: 1.25rem; cursor: pointer; padding: 0.25rem; line-height: 1;">&times;</button>
            </div>
        </div>
                            ...
                            <div style="flex: 1;">
                                ...
                                <div style="margin-bottom: 0.4rem;">
                                    ...
                                    <div style="display: flex; gap: 0.2rem; flex-wrap: wrap;">
                                        ...
                                        <button type="button" wire:click="applyLocationTemplate('desert')" style="padding: 0.15rem 0.3rem; background: rgba(245, 158, 11, 0.2); border: 1px solid rgba(245, 158, 11, 0.4); border-radius: 0.15rem; color: var(--vw-text); font-size: 0.5rem; cursor: pointer;">🏜️ {{ __('Desert') }}</button>
