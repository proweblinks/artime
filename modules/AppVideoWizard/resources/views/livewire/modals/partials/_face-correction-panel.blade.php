...
<div style="border-top: 1px solid rgba(255,255,255,0.1); padding: 1rem 1.25rem; background: rgba(0,0,0,0.2);">
    ...
    <div style="display: flex; gap: 0.75rem;">
        <button type="button"
                ...
                style="flex: 1; padding: 0.75rem; background: linear-gradient(135deg, #03fcf4, #00d4cc); border: none; border-radius: 0.5rem; color: #0a2e2e; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; {{ $faceCorrectionStatus === 'processing' ? 'opacity: 0.5;' : '' }}">
