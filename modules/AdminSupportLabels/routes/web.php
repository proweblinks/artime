...
Route::middleware(['web', 'auth'])->group(function () {
    Route::group(["prefix" => "admin"], function () {
        Route::group(["prefix" => "support/labels"], function () {
            ...
            Route::post('update', [AdminSupportLabelsController::class, 'update'])->name('admin.support.labels.ajax-update');
            ...
            Route::post('destroy', [AdminSupportLabelsController::class, 'destroy'])->name('admin.support.labels.ajax-destroy');
        });
    });
});
