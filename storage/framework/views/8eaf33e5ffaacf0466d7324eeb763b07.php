  ...
  <div class="container px-4 mx-auto">
    <div class="mb-20 text-center md:max-w-xl mx-auto">
      ...
      <p class="text-lg text-gray-600 font-medium leading-normal md:max-w-lg mx-auto">
        <?php echo e(get_option('contact_company_name', 'Your Company Name')); ?>
    ...
    <div class="flex flex-wrap xl:items-center -m-8">
      <div class="w-full md:w-1/2 p-8">
        <div class="max-w-max mx-auto overflow-hidden rounded-3xl">
          <img class="transform hover:scale-105 transition ease-in-out duration-1000" src="<?php echo e(theme_public_asset('images/contact/man.png')); ?>" alt=""/>
        </div>
      </div>
      <div class="w-full md:w-1/2 p-8">
        ...
        <ul class="mb-8">
          <li class="text-lg text-gray-600 font-medium leading-normal">
            <a href="<?php echo e(get_option('contact_company_website', '#')); ?>" class="text-indigo-700 hover:underline" target="_blank">
              <?php echo e(get_option('contact_company_website', 'https://yourcompany.com')); ?>
        ...
        <ul class="mb-8">
          <li class="text-lg text-gray-600 font-medium leading-normal">
            <?php echo e(get_option('contact_email', 'support@yourcompany.com')); ?>
        ...
        <ul class="mb-8">
          <li class="text-lg text-gray-600 font-medium leading-normal">
            <?php echo e(get_option('contact_phone_number', '+1 234 567 890')); ?>
        ...
        <ul class="mb-8">
          <li class="text-lg text-gray-600 font-medium leading-normal">
            <?php echo e(get_option('contact_working_hours', 'Mon - Fri: 09:00 AM - 06:00 PM')); ?>
        ...
        <ul>
          <li class="text-lg text-gray-600 font-medium leading-normal">
            <?php echo e(get_option('contact_location', '123 Main Street, City, Country')); ?>
...
<?php /**PATH /home/artime/public_html/resources/themes/guest/nova/resources/views/pages/contact.blade.php ENDPATH**/ ?>